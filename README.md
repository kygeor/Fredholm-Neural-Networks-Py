...
$$ u(x) = \int_{\partial \Omega} \big(\beta(y) -  \beta(x^{\star}) \big)
    \Big(\frac{\partial \Phi(x, y)}{\partial n_{y}}  - \frac{\partial \Phi(x^{\star}, y)}{\partial n_{y}} \Big) d\sigma_{y} + \frac{1}{2} \beta(x^{\star})  + \int_{\partial \Omega} \beta(y) \frac{\partial \Phi(x^{\star}, y)}{\partial n_{y}} d\sigma_y + \int_{\Omega} \Phi(x, y) \psi(y) dy. $$
